...
Funcionalidade: F10 - Cálculo de Comissão e Repasse de Especialista
  ...
  Contexto:
    ...
    E que existe um plano de tratamento aprovado com o procedimento "Implante" no valor de R$ 2.000,00
  ...
  Cenário: Estornar repasse com justificativa
    ...
    E a justificativa "Procedimento refeito sem custo" deve ser registrada
