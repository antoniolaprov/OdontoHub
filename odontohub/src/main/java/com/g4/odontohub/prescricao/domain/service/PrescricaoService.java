...
public class PrescricaoService {
    ...
    private final Map<Long, Prescricao> repositorio = new HashMap<>();
    ...
    public Prescricao registrarPrescricao(String paciente, String dentista, List<ItemPrescricao> itens,
        ...
        PrescricaoId id = new PrescricaoId(nextId++);
        ...
        repositorio.put(id.id(), prescricao);
    ...
    public Prescricao buscar(Long id) {
        Prescricao prescricao = repositorio.get(id);
        if (prescricao == null) {
